...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SendEmail_t, stringdata) + ofs \
...
const QMetaObject SendEmail::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SendEmail.data,
      qt_meta_data_SendEmail,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SendEmail.stringdata))
